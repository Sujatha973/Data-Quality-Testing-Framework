...
def _get_context(context):
    if not hasattr(context, "_ge_context") or context._ge_context is None:
...
def step_expectation_should_pass(context, expectation_type, column):
    ...
    total = result.result.get("element_count", context.row_count if hasattr(context, "row_count") else "?")
